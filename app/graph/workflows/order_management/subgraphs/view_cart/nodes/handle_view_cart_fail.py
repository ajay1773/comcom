...
async def handle_view_cart_fail_node(state: ViewCartState) -> ViewCartState:
    ...
    try:
        ...
        elif "session" in error_message.lower() or "expired" in error_message.lower():
        ...
        elif "not found" in error_message.lower() or "empty" in error_message.lower():
    ...
    if "authentication" in error_message.lower() or "user" in error_message.lower():
        ...
        recovery_options = ["Try again", "Browse products", "Contact support"]
